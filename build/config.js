...
module.exports = {
	...
	historySearchForm: {
		testHistorySearchTypes: [{ text: 'All test history', href: '/prototype/test-history' }, { text: 'Registration number', href: '/prototype/test-history/registration-number' }, { text: 'Chassis number', href: '/prototype/test-history/chassis-number' }]
	},
